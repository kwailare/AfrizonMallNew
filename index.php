...
<head>
	...
	<meta name="google-site-verification" content="bosdM1VLhtCoK6KNDLijvmQH6_5pd4ZqNWxpe9xNSlQ" />

	<!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-219284116-1">
</script>
<script>
...
<!-- 
						<li class="open"><a href="valentine.html">Valentine Special</a>
						</li>
						 -->
	...
	<!-- end new collection directory -->
				...
				<h1 id="Tees" style="color: #a39d94;">TEES</h1>
	...
	<h1 id="Joggers" style="color: #a39d94;">JOGGERS</h1>
	<div id="shop-all" class="row">
		<!-- Product Item #1 -->
		<div class="col-xs-12 col-sm-6 col-md-4 product-item filter-best">
			<div class="product-img">
			...
			<div style="background-color:maroon;color:white;padding:10px;border-radius:5px;margin:5px;font-size:35px;z-index:2;"> Sold Out! </div>
